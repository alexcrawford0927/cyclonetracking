...
bboxName =  path+"/Projections/EASE2_N0_"+str(spres)+"km_Projection_uv.nc"  # path+"/Projections/EASE2_N0_25km_GenesisRegions.pkl" # "/Volumes/Cressida/Projections/EASE2_N0_100km_SeaIceRegions.pkl" #
# bboxName =  path+"/Projections/EASE2_N0_"+str(spres)+"km_GenesisRegions.nc"  # path+"/Projections/EASE2_N0_25km_GenesisRegions.pkl" # "/Volumes/Cressida/Projections/EASE2_N0_100km_SeaIceRegions.pkl" #
ncvar = 'z' # 'CAO2' #'reg' # 'z' # Set to None unless file is a netcdf
...
bboxnum = "10" # Just the number, don't include "BBox"
...
endtime = [1979,3,1,0,0,0] # stop BEFORE this time (exclusive)
